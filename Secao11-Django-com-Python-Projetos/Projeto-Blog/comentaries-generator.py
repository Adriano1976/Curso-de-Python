...
comentary = ".It is a long established fact that a reader will be distracted by the readable " \
...
for i in range(1, 6):  # 5 comentários por post
    for post_comentario_id in range(1, 50):  # Assume 20 posts criados
        nome_comentario = ''.join(random.choices(ALPHABET, k=8))
        email_comentario = f'{nome_comentario}@gmail.com'
        comentario = comentary * random.randint(3, 4) + '. '
