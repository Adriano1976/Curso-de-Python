# Generated by Django 4.0.2 on 2022-03-20 04:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagem', models.ImageField(blank=True, null=True, upload_to='produto_imagens/%Y/%m/', verbose_name='Imagem')),
                ...
                ('tipo', models.CharField(choices=[('V', 'Variação'), ('S', 'Simples')], default='v', max_length=1, verbose_name='Tipo')),
            ],
        ),
    ]
