...
SECRET_KEY = 'django-insecure-6efne*3ycyot^s48!qr$ry=ri0s0_im@qt2lz-9oqer6t@*@c='
...
# Registrando os 'apps' criados na pasta contatos/templates/apps.py na classe ContatosConfig
...
TEMPLATES = [
    {
        ...
        # Informando ao Django onde encontrar o conteúdo da pasta 'static'
