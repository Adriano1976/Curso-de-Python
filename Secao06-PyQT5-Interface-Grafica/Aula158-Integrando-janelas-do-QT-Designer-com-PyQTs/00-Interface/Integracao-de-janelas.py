...
class App(QMainWindow):
    def __init__(self, parent=None):  # Método inicializador
    ...
    def abrir_janela(self):  # Método abrir janela
    ...
    def fechar_janela(self):  # Método fechar janela
...
class Janela(QMainWindow):
    ...
    def muda_botao_da_janela_principal(self):  # Método mudar botão da janela principal
