"""
- Quando a existência de uma classe depende de outra classe, como é a relação da classe Histórico
com a classe Conta, dizemos que a classe Historico compõe a classe Conta. Essa associação chamamos COMPOSIÇÃO.
"""
...
print()
print(f'Titular da conta {conta_A.numero}: {conta_A.titular._nome} {conta_A.titular._sobrenome}')
print(f'Titular da Conta {conta_N.numero}: {conta_N.titular._nome} {conta_N.titular._sobrenome}')
print(f'Titular da Conta {conta_L.numero}: {conta_L.titular._nome} {conta_N.titular._sobrenome}')
...
print(f'\tConta: {conta_A.numero}\n'
      f'\tTitular: {conta_A.titular._nome} {conta_A.titular._sobrenome}\n'
      f'\tSaldo: {conta_A.saldo}\n'
      f'\tLimite: {conta_A.limite}\n'
      f'------- {conta_A.historico._data_abertura} --------\n')

print('-------------------------------------------')
print('|        DADOS DA CONTA DO CLIENTE        |')
print('-------------------------------------------')
print(f'\tConta: {conta_N.numero}\n'
      f'\tTitular: {conta_N.titular._nome} {conta_N.titular._sobrenome}\n'
