...
a classe Conta, dizemos que a classe Historico compõe a classe Conta. Essa associação chamamos COMPOSIÇÃO.
"""
import datetime
...
class Conta:
    ...
    def transfere_para(self, destino, valor):
        ...
        if not retirou:
            ...
            self.historico.transacoes.append(f'Transferência de R$ {valor} para a conta {destino._numero}')
            return True
